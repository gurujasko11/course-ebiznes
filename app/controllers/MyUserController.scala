...
import models.MyUserRepository
 ...
 */
@Singleton
class MyUserController @Inject() (userRepository: MyUserRepository, cc: ControllerComponents)(implicit ec: ExecutionContext) extends AbstractController(cc) {
